                ...
                <div class="px-5 py-2.5 flex flex-wrap gap-2 bg-gray-50/30 border-b border-gray-100">
                    ...
                    <button @click="statusFilter = 'pending'"
                        ...
                        <span class="w-1.5 h-1.5 rounded-full"
                            :class="statusFilter === 'pending' ? 'bg-white' : 'bg-amber-400'"></span>
                        Menunggu
                        <span class="opacity-70">({{ $pendingCount }})</span>
                    </button>
                    ...
                    <button @click="statusFilter = 'verified'"
                        ...
                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold border transition-all">
                        <span class="w-1.5 h-1.5 rounded-full"
                            :class="statusFilter === 'verified' ? 'bg-white' : 'bg-emerald-400'"></span>
                        Terverifikasi
                        <span class="opacity-70">({{ $verifiedCount }})</span>
                    </button>
                    ...
                    <button @click="statusFilter = 'rejected'"
                        ...
                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold border transition-all">
                        <span class="w-1.5 h-1.5 rounded-full"
                            :class="statusFilter === 'rejected' ? 'bg-white' : 'bg-rose-400'"></span>
                        Ditolak
                        <span class="opacity-70">({{ $rejectedCount }})</span>
                    </button>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @forelse ($siswa as $index => $g)
                                ...
                                <tr class="hover:bg-gray-50/70 transition-colors"
                                    ...
                                    {{-- Siswa: avatar + nama + NIS + gender in one cell --}}
